...
- Minor: Added channel name to placeholder chat input text.
- Minor: Added toggle for displaying placeholder text.
- Minor: Added roles information to usercard.
- Minor: Added open/copy [RaccAttack](https://emotes.raccatta.cc/) emote link for twitch emotes.
- Minor: Added toggle for graying-out recent messages.
- Minor: Added toggle for normal/bot rate limits.
- Minor: Added webchat detection.
- Minor: Added abnormal nonce detection.
- Minor: Added logs button to usercard to open [3rd-party logging service](https://logs.ivr.fi). (#1)
